...
from all_books.views import add_book, all_request_listview, cover, request_decision, reject_request
...
urlpatterns = [
    ...
    path('librarian_controls/', all_request_listview, name='librarian_controls'),
